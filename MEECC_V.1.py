...
# Load shapefile (ensure .shp, .shx, .dbf, etc., are all present)
basemap = gpd.read_file(os.path.join(DATA_PATH, "world-administrative-boundaries.shp"))
print(basemap.head())
basemap.plot()
print(basemap.crs)
...
#  Add this just after you load your data
...
app.layout = html.Div([
    # Title
    html.H1("Model for Energy Equity and Climate Compatibility_Version.1 (MEECC_V.1-beta)", style={"textAlign": "center"}),
                ...
                dcc.Tab(label="Clustering Method", value="clustering_method", children=[
                    html.Div([
                        ...
                        dcc.RadioItems(
                            ...
                            options=[
                                {"label": "1. Equal weighting of all development variables", "value": "equal_weighting"},
                                {"label": "2. UMAP + KMeans", "value": "umap_kmeans"},
                                {"label": "3. Based on Per capita GDP", "value": "per_capita_GDP"},
                                {"label": "4. Based on Per capita Emissions", "value": "per_capita_emission"},
                                {"label": "5. Based on Historical Emissions", "value": "historical_emissions"},
                                {"label": "6. Based on CBDR&RC", "value": "CBDR&RC"}                                
                            ],
